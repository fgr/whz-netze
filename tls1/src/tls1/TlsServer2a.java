...
/**
 * Verwendet im Gegensatz zu {@link TlsServer2} die Vorgaben von
 * {@link StrongTls} bzgl. <em>starker</em> Verschluesselungsverfahren.
 * 
...
public class TlsServer2a {
	public static void main(String[] args) throws Exception {
		...
		try (ServerSocket serverSocket = new ServerSocket(port)) {
			...
			s.setEnabledProtocols(StrongTls.ENABLED_PROTOCOLS);
			s.setEnabledCipherSuites(StrongTls.ENABLED_CIPHER_SUITES);
